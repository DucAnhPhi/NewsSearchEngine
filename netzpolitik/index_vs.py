...
if __name__ == "__main__":
    ...
    print("Initialize netzpolitik vector storage of embeddings of titles w/ first paragraph.\n")
    ...
    print("Initialize netzpolitik vector storage of embeddings of extracted tf-idf keywords.\n")
    ...
    print("Initialize netzpolitik vector storage of embeddings of titles and section titles.\n")
    ...
    print("Initialize netzpolitik vector storage of embeddings of titles.\n")
